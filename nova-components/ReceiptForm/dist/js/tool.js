...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_flatpickr_component__ = __webpack_require__(14);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_flatpickr_dist_flatpickr_css__ = __webpack_require__(19);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    ...
    return {
      ...
      }, _defineProperty(_frontEndError, "purchaseDate", {
        required: false
      }), _defineProperty(_frontEndError, "amount", {
        required: false
      }), _frontEndError),
      errors: {},
      config: {
  ...
  mounted: function mounted() {
    ...
    if (!this.showAddReceipt) {
      document.getElementById("get-detail").addEventListener("keyup", function (event) {
        if (event.code === "Enter") {
    ...
    if (this.showAddReceipt) {
      document.getElementById("submit-receipt").addEventListener("keyup", function (event) {
        if (event.code === "Enter") {
          event.preventDefault();
          document.querySelector("form").submit();
        }
  ...
  methods: {
    getCountries: function getCountries() {
      ...
      Nova.request().get("/nova-vendor/receipt-form/init").then(function (response) {
        _this.isLoaded = true;
        if (response.data) {
          _this.countries = response.data.countries;
          _this.form.country = _this.countries.find(function (el) {
            return el.country_code == "BH";
          });
          _this.countryCode = _this.form.country.phone_code;
          _this.shops = response.data.shops;
          _this.form.shopName = response.data.shops[0];
        }
      }, function (error) {});
    },
    ...
    getCustomerDetails: function getCustomerDetails() {
      ...
      if (this.form.phone && this.form.phone.length != this.form.country.phone_digits) {
      ...
      Nova.request().post("/nova-vendor/receipt-form/customer", data, this.formConfig).then(function (response) {
        _this2.showAddReceipt = true;
        if (response.data.data) {
          _this2.oldCustomerData = response.data.data;
          if (_this2.oldCustomerData.name) {
            _this2.form.name = _this2.oldCustomerData.name;
          }
          if (_this2.oldCustomerData.email) {
            _this2.form.email = _this2.oldCustomerData.email;
          }
          if (_this2.oldCustomerData.cpr) {
            _this2.form.cpr = _this2.oldCustomerData.cpr;
          }
          if (_this2.oldCustomerData.nationality) {
            _this2.form.nationality = _this2.oldCustomerData.nationality;
            _this2.oldCustomerData.nationality = _this2.countries.find(function (el) {
              return el.id == _this2.oldCustomerData.nationality;
            });
          }
          if (_this2.oldCustomerData.country_id && !_this2.oldCustomerData.nationality) {
            _this2.oldCustomerData.nationality = _this2.countries.find(function (el) {
              return el.id == _this2.oldCustomerData.country_id;
            });
          }
          console.log(_this2.oldCustomerData);
        } else {
          _this2.$toasted.show("No record found", {
            type: "error"
          });
          _this2.form.name = null;
          _this2.form.email = null;
          _this2.form.cpr = null;
          _this2.oldCustomerData = null;
        }
      }, function (error) {});
    },
    ...
    addCustomer: function addCustomer() {
      ...
      customerData.receipts = this.formData.map(function (el) {
        return {
          shop_id: el.shop.id,
      ...
      Nova.request().post("/nova-vendor/receipt-form/create-receipt", customerData, this.formConfig).then(function (response) {
        if (response.data.status == "error" && response.data.message == "Receipt already exists") {
          _this3.$toasted.show(response.data.message, {
            type: "error"
          });
        }
        if (response.data.status == "error" && response.data.message.includes("Amount should be greater")) {
          _this3.$toasted.show(response.data.message, {
            type: "error"
          });
        }
        if (response.data.status == "error" && response.data.message == 'Receipt should be unique per shop') {
          _this3.$toasted.show(response.data.message, {
            type: "error"
          });
        }
        ...
        if (response.data.status == "success" && response.data.data) {
          _this3.$toasted.show("Record inserted successfully", {
            type: "success"
          });
          setTimeout(function () {
        ...
        if (error.response) {
          if (error.response.status == 422) {
            ...
            _this3.$toasted.show("Some Fields are missing", { type: "error" });
          } else if (error.response.status == 413) {
            _this3.$toasted.show("Some fields may be invalid or file size may be too large", { type: "error" });
          } else {
            _this3.$toasted.show("Server Error", { type: "error" });
          }
        } else if (error.request) {
          console.log("request:", error.request);
          _this3.$toasted.show("Server not responding", { type: "error" });
        } else {
          console.log("else Error", error.message);
          _this3.$toasted.show(error.message || "Error in request, please contact to support", { type: "error" });
        }
      });
    },
    ...
    recordError: function recordError(errors) {
      this.errors = errors;
    },
    createError: function createError(field, msg) {
    ...
    clearError: function clearError(field) {
      if (field) {
        ...
        if (this.frontEndError[field]) {
          for (var prop in this.frontEndError[field]) {
    ...
    checkCprValidation: function checkCprValidation() {
      var cpr = null;
      if (this.form && this.form.country.country_code == "BH") {
        this.clearError("cpr");
        cpr = this.form.cpr;
        ...
        if (this.form && this.form.country.country_code == "BH" && cpr.length < 9) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_dom__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__utils_dates__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__utils_formatting__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__utils_polyfills__ = __webpack_require__(18);
...
function FlatpickrInstance(element, instanceConfig) {
    ...
    function isDateSelected(date) {
        for (var i = 0; i < self.selectedDates.length; i++) {
            ...
            if (selectedDate instanceof Date && Object(__WEBPACK_IMPORTED_MODULE_4__utils_dates__["b" /* compareDates */])(selectedDate, date) === 0)
                return "" + i;
        }
        return false;
    }
...
var render = function() {
  ...
  return _c(
    ...
    [
      _vm._m(0),
      _vm._v(" "),
      _c("heading", { staticClass: "mb-6" }, [_vm._v("Create Form")]),
      _vm._v(" "),
      _vm.isLoaded && _vm.countries.length
        ? _c("section", [
            _c(
              "form",
              {
                attrs: { autocomplete: "off", id: "get-detail" },
                on: {
                  submit: function($event) {
                    $event.preventDefault()
                    return _vm.getCustomerDetails.apply(null, arguments)
                  },
              ...
              [
                _c("card", { staticClass: "nova-grid-card-styles" }, [
                  _c("section", { staticClass: "player-detail-section" }, [
                    _c(
                      "div",
                      { staticClass: "flex px-4 border-b border-40 pb-6" },
                      [
                        _c("div", { staticClass: "w-1/3 mt-3 mr-2" }, [
                          _c("div", { staticClass: "nova-grid-wrapper" }, [
                            _c(
                              "div",
                              { staticClass: "nova-grid-field-label" },
                              [
                                _c(
                                  "label",
                                  {
                                    staticClass:
                                      "inline-block text-80 pt-2 pb-2 leading-tight"
                                  },
                                  [
                                    _vm._v("Select Country"),
                                    _c("label", { staticClass: "color-red" }, [
                                      _vm._v("*")
                                    ])
                                  ]
                                )
                              ...
                              [
                                _c(
                                  ...
                                  [
                                    ...
                                    _vm._v(" "),
                                    _vm._l(_vm.countries, function(list) {
                                      return _c(
                                        "option",
                                        {
                                          key: list.id,
                                ...
                                _vm._v(" "),
                                _vm.frontEndError.country.required ||
                                _vm.hasError("country")
                                  ? _c(
                                      ...
                                      [_vm._v("The country field is required.")]
                                    )
                                  : _vm._e()
                              ]
                            )
                          ...
                          _vm.hasError("phone")
                            ? _c("span", {
                                staticClass:
                                  "help-text help-text mt-2 text-danger",
                                domProps: {
                                  textContent: _vm._s(_vm.getError("phone"))
                                }
                              })
                            : _vm._e(),
                          _vm._v(" "),
                          _vm.frontEndError.phone.required
                            ? _c(
                                "span",
                                {
                                  staticClass:
                                ...
                                [_vm._v("The phone field in required")]
                              )
                            : _vm._e(),
                          _vm._v(" "),
                          _vm.frontEndError.phone.incomplete
                            ? _c(
                                "span",
                                {
                                  staticClass:
                                ...
                                [
                                  _vm._v(
                                    "The phone must be\n                " +
                                      _vm._s(_vm.form.country.phone_digits) +
                                      " digits"
                                  )
                                ]
                              )
                            : _vm._e(),
                          _vm._v(" "),
                          _vm.frontEndError.phone.invalid
                            ? _c(
                                "span",
                                {
                                  staticClass:
                        ...
                        _c(
                          ...
                          {
                            staticClass:
                              "w-1/3 mt-3 mr-2 flex justify-end items-end"
                          },
                          [
                            _c(
                              "button",
      ...
      _vm.oldCustomerData
                      ...
                      [
                        _c("thead", [
                          _c("tr", [
                            _c("th", { staticClass: "text-left" }, [
                              _c(
                                "span",
                                {
                                  ...
                                  attrs: { dusk: "sort-receipt_number" }
                                },
                                [
                                  _vm._v(
                                    "\n                  Name\n                "
                            ...
                            _vm._v(" "),
                            _c("th", { staticClass: "text-left" }, [
                              _c("span", [_vm._v("CPR/Passport")])
                            ]),
                            _vm._v(" "),
                            _vm.oldCustomerData &&
                            _vm.oldCustomerData.nationality
                              ? _c("th", { staticClass: "text-left" }, [
                            ...
                            _vm._v(" "),
                            _c("th", { staticClass: "text-left" }, [
                              _c("span", [_vm._v("View Detail")])
                            ])
                          ])
                        ]),
                        _vm._v(" "),
                        _c("tbody", [
                          _c("tr", { attrs: { dusk: "27-row" } }, [
                            _c("td", [
                              _c(
                                "div",
                                  ...
                                  _c(
                                    ...
                                    [
                                      _vm._v(
                                        _vm._s(
                                          _vm.oldCustomerData &&
                                            _vm.oldCustomerData.receipts_count
                                        )
                                      )
                                    ]
                                  )
        ...
        : _vm._e(),
      _vm._v(" "),
      _vm.isLoaded && _vm.countries.length && _vm.showAddReceipt
        ? _c("section", { staticClass: "new-application pt-6" }, [
            _c(
              "form",
              {
                attrs: { autocomplete: "off", id: "submit-receipt" },
                on: {
                  submit: function($event) {
                    $event.preventDefault()
              ...
              [
                _c(
                  "card",
                  { staticClass: "nova-grid-card-styles" },
                  [
                    !_vm.oldCustomerData
                      ? _c(
                          "div",
                          ...
                          [
                            !_vm.oldCustomerData
                              ? _c("div", { staticClass: "w-1/2 mt-3 mr-2" }, [
                                  _c(
                                    "div",
                                    { staticClass: "nova-grid-wrapper" },
                                    [
                                      _c(
                                        "div",
                                        {
                                      ...
                                      _c("div", { staticClass: "w-full" }, [
                                        ...
                                        _vm._v(" "),
                                        _vm.frontEndError.fullName.required
                                          ? _c(
                                              "span",
                                              {
                                                staticClass:
                              ...
                              ? _c("div", { staticClass: "w-1/2 mt-3 mr-2" }, [
                                  _c(
                                    ...
                                    [
                                      ...
                                      _c("div", { staticClass: "w-full" }, [
                                        _vm.form.country &&
                                        _vm.form.country.country_code == "BH"
                                          ? _c("input", {
                                              directives: [
                                                {
                                                  name: "model",
                                        ...
                                        _vm.form.country.country_code == "BH"
                                          ...
                                          : _vm._e(),
                                        _vm._v(" "),
                                        _vm.frontEndError.cpr.required
                                          ? _c(
                                              "span",
                                              {
                                                staticClass:
                                          ...
                                          : _vm._e(),
                                        _vm._v(" "),
                                        _vm.frontEndError.cpr.incomplete &&
                                        _vm.form.country &&
                                        _vm.form.country.country_code == "BH"
                                          ? _c(
                                              "span",
                                              ...
                                              [
                                                _vm._v(
                                                  "The cpr should be 9 digitsss"
                                                )
                                              ]
                                            )
                                          : _vm._e(),
                                        _vm._v(" "),
                                        _vm.frontEndError.cpr.monthInvalid &&
                                        _vm.form.country &&
                                        _vm.form.country.country_code == "BH"
                                          ? _c(
                                              "span",
                                  ...
                                  _c(
                                    ...
                                    [
                                      ...
                                      _c("div", { staticClass: "w-full" }, [
                                        ...
                                        _vm._v(" "),
                                        _vm.frontEndError.nationality
                                          .required ||
                                        _vm.hasError("nationality")
                                          ? _c(
                                              "span",
                                              {
                                                staticClass:
                                  ...
                                  _c(
                                    ...
                                    [
                                      ...
                                      _c("div", { staticClass: "w-full" }, [
                                        ...
                                        _vm._v(" "),
                                        _vm.frontEndError.email.required
                                          ? _c(
                                              "span",
                                              {
                                                staticClass:
                      ...
                      : _vm._e(),
                    _vm._v(" "),
                    _vm._l(_vm.formData, function(entry, index) {
                                ...
                                _c("div", { staticClass: "w-full" }, [
                                  _c(
                                    ...
                                    [
                                      ...
                                      _vm._v(" "),
                                      _vm._l(_vm.shops, function(list) {
                                        return _c(
                                          "option",
                                          {
                                            key: list.id,
                                  ...
                                  _vm._v(" "),
                                  _vm.hasError("receipts." + index + ".shop_id")
                                    ? _c("span", {
                                        staticClass:
                                          "help-text help-text mt-2 text-danger",
                                        domProps: {
                                  ...
                                  [
                                    _c("flat-pickr", {
                                      ...
                                      model: {
                                        ...
                                        callback: function($$v) {
                                          _vm.$set(entry, "purchaseDate", $$v)
                                        },
                                        expression: "entry.purchaseDate"
                                      }
                                    }),
                                    _vm._v(" "),
                                    _vm.hasError(
                                      "receipts." + index + ".purchase_date"
                                    )
                                      ? _c("span", {
                                          staticClass:
                                            "help-text help-text mt-2 text-danger",
                            ...
                            _c("div", { staticClass: "w-1/3 mt-3 mr-2" }, [
                              _c("div", { staticClass: "nova-grid-wrapper" }, [
                                ...
                                _c("div", { staticClass: "w-full" }, [
                                  ...
                                  _vm._v(" "),
                                  _vm.hasError("receipts." + index + ".amount")
                                    ? _c("span", {
                                        staticClass:
                                          "help-text help-text mt-2 text-danger",
                                        domProps: {
