...
use App\Nova\Metrics\Locations;
use App\Nova\Metrics\Receipt;
use App\Nova\Metrics\ReceiptAmount;
use App\Nova\Metrics\Receipts;
use App\Nova\Metrics\ReceiptsPerShop;
use App\Nova\Metrics\ReceiptsPerUser;
use App\Nova\Metrics\Shops;
...
class NovaServiceProvider extends NovaApplicationServiceProvider
{
    ...
    {
        parent::boot();
        Nova::style('cms', public_path('css/nova.css'));
    }
    ...
    public function tools()
    {
            ...
            'navigation' => [
                TopLevelResource::make([
                    ...
                    'resources' => [
                        ...
                        InternalLink::make([
                            'label' => 'Customers',
                            'badge' => null,
                            'icon' => '<svg style="height: 23px;" viewBox="0 0 16 16"  fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4 10a1 1 0 0 1 2 0v2a1 1 0 0 1-2 0v-2zm3 0a1 1 0 0 1 2 0v2a1 1 0 0 1-2 0v-2zm3 0a1 1 0 1 1 2 0v2a1 1 0 0 1-2 0v-2z M5.757 1.071a.5.5 0 0 1 .172.686L3.383 6h9.234L10.07 1.757a.5.5 0 1 1 .858-.514L13.783 6H15.5a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-.623l-1.844 6.456a.75.75 0 0 1-.722.544H3.69a.75.75 0 0 1-.722-.544L1.123 8H.5a.5.5 0 0 1-.5-.5v-1A.5.5 0 0 1 .5 6h1.717L5.07 1.243a.5.5 0 0 1 .686-.172zM2.163 8l1.714 6h8.246l1.714-6H2.163z"/></svg>',
                            'target' => '',
                        ...
                        InternalLink::make([
                            'label' => 'Raffles',
                            'badge' => null,
                            'icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-ticket-fill" viewBox="0 0 16 16">
                ...
                TopLevelResource::make([
                    ...
                    'resources' => [
                        ...
                        //     'label' => 'Campaign',
                        //     'badge' => null,
                        //     'icon' => '<svg style="height: 23px;" viewBox="0 0 16 16"  fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M15 14s1 0 1-1-1-4-5-4-5 3-5 4 1 1 1 1h8zm-7.978-1A.261.261 0 0 1 7 12.996c.001-.264.167-1.03.76-1.72C8.312 10.629 9.282 10 11 10c1.717 0 2.687.63 3.24 1.276.593.69.758 1.457.76 1.72l-.008.002a.274.274 0 0 1-.014.002H7.022zM11 7a2 2 0 1 0 0-4 2 2 0 0 0 0 4zm3-2a3 3 0 1 1-6 0 3 3 0 0 1 6 0zM6.936 9.28a5.88 5.88 0 0 0-1.23-.247A7.35 7.35 0 0 0 5 9c-4 0-5 3-5 4 0 .667.333 1 1 1h4.216A2.238 2.238 0 0 1 5 13c0-1.01.377-2.042 1.09-2.904.243-.294.526-.569.846-.816zM4.92 10A5.493 5.493 0 0 0 4 13H1c0-.26.164-1.03.76-1.724.545-.636 1.492-1.256 3.16-1.275zM1.5 5.5a3 3 0 1 1 6 0 3 3 0 0 1-6 0zm3-2a2 2 0 1 0 0 4 2 2 0 0 0 0-4z"/></svg>',
                        //     'target' => '',
                        ...
                        InternalLink::make([
                            ...
                            'badge' => null,
                            'target' => '',
                            'icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-globe2" viewBox="0 0 16 16">
                        ...
                        InternalLink::make([
                            ...
                            'badge' => null,
                            'target' => '',
                            'icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-shop" viewBox="0 0 16 16">
                        ...
                        InternalLink::make([
                            'label' => 'SMS Logs',
                            'badge' => null,
                            'icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chat-text-fill" viewBox="0 0 16 16">
                            <path d="M16 8c0 3.866-3.582 7-8 7a9.06 9.06 0 0 1-2.347-.306c-.584.296-1.925.864-4.181 1.234-.2.032-.352-.176-.273-.362.354-.836.674-1.95.77-2.966C.744 11.37 0 9.76 0 8c0-3.866 3.582-7 8-7s8 3.134 8 7zM4.5 5a.5.5 0 0 0 0 1h7a.5.5 0 0 0 0-1h-7zm0 2.5a.5.5 0 0 0 0 1h7a.5.5 0 0 0 0-1h-7zm0 2.5a.5.5 0 0 0 0 1h4a.5.5 0 0 0 0-1h-4z"/>
                          </svg>',
                            'target' => '',
                            'path' => '/resources/sms-logs',
                        ]),
                    ],
                ])->canSee(function ($request) {
                    return $request->user()->isAdmin();
        ...
        $dashboardTools[] = (new LogsTool)->canSee(function ($request) {
            return $request->user()->isAdmin();
        });
        $dashboardTools[] = (new ReceiptForm);
